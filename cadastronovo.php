...
.overlay {
	background: #f7663e;
	background: -webkit-linear-gradient(to right, #FF4B2B, #f7663e);
	background: linear-gradient(to right, #FF4B2B, #f7663e);
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				...
				<p>Se você não possui uma conta ainda clique no botão abaixo</p>
