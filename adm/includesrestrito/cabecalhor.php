...
<body>
    <header style="height: 50px;">
        <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand ml-5" href="#"><img src="/amigossolidarios/adm/img/icon.png" alt="logo" style="width: 30%;"></a>
            ...
            <ul class="navbar-nav px-3 d-none d-md-block">
                <li class="nav-item text-nowrap"><a href="#" class="nav-link"><strong>Sair</strong></a></li>
            </ul>
        </nav>
    </header>
            ...
            <nav id="menuLateral" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="margin-top: -20px;">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column mt-1" style="text-align: justify;">
                        ...
                        <li class="nav-item mb-2" style="color: #09105B;"><strong>BEM-VINDO <?php echo $_SESSION['NOME'];?></strong></li>
